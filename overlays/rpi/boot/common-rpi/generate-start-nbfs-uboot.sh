...
mkimage -A arm -O linux -T script -C none -n start-nbfs-uboot.scr -d $SCRIPT start-nbfs.uboot
echo "start-nbfs.uboot was generated in the current directory."
rm $SCRIPT
exit
...
setenv bootargs "$bootargs $nbfs_bootargs $ip_conf $other_bootargs"
